...
//		api.getDefaultCommander(FleetSide.PLAYER).getStats().setSkillLevel(Skills.ELECTRONIC_WARFARE, 3);
		...
		api.addToFleet(FleetSide.PLAYER, "hound_Standard", FleetMemberType.SHIP, "Stranger II", true);
		api.addToFleet(FleetSide.PLAYER, "hound_Standard", FleetMemberType.SHIP, "Milk Run", false);
		
		// Set up the enemy fleet.
		api.addToFleet(FleetSide.ENEMY, "hound_Standard", FleetMemberType.SHIP, "Cherenkov Bloom", false);
